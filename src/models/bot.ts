...
export class Bot {
    ...
    private async onGuildJoin(guild: Guild): Promise<void> {
        ...
        await UpdateInformation.InitGuildDb(guild);
        await UpdateInformation.CreateBotAdminRole(guild);
        await UpdateInformation.CreateBotInfoChannel(guild);
        await UpdateInformation.UploadCharacterEmojisAndRoles(guild);
        await UpdateInformation.initDirectoryChannel(guild);
